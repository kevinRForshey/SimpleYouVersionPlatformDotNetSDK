...
/// <see cref="OAuth.ITokenProvider"/> and attaches it as an
...
{
    private readonly OAuth.ITokenProvider _tokenProvider;
    private readonly OAuth.IYouVersionOAuthClient _oAuthClient;
    ...
    public OAuthBearerTokenHandler(
        OAuth.ITokenProvider tokenProvider,
        OAuth.IYouVersionOAuthClient oAuthClient,
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (token is not null && token.IsExpired(_apiOptions.OAuthTokenExpiryBufferSeconds))
        {

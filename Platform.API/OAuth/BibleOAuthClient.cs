...
/// <summary>
/// Default implementation of <see cref="IBibleOAuthClient"/>.
/// </summary>
internal sealed class BibleOAuthClient : IBibleOAuthClient
{
    private readonly HttpClient _httpClient;
    private readonly BibleOAuthOptions _options;
    private readonly BibleApiOptions _apiOptions;
    private readonly ITokenProvider _tokenProvider;
    private readonly ILogger<BibleOAuthClient> _logger;

    public BibleOAuthClient(
        HttpClient httpClient,
        IOptions<BibleOAuthOptions> options,
        IOptions<BibleApiOptions> apiOptions,
        ITokenProvider tokenProvider,
        ILogger<BibleOAuthClient> logger)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // No status-code check beyond "did we get a Location to follow" — the platform's docs say
        ...
        if (string.IsNullOrWhiteSpace(code))
            throw new BibleEmptyResponseException(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return result ?? throw new BibleEmptyResponseException(
